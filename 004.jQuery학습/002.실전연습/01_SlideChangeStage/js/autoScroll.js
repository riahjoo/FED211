...
$(function(){/////////////jQB///////////////////////
    ...
    /* 
        ...
        2. 이벤트 : 마우스휠을 움직일때 발생하는 이벤트는?
          ...
          - DOMMouseScroll (파이어폭스 전용이벤트)
           ...
           mousewheel + DOMMouseScroll을 같이 사용할 것 임
        ...
        할 수 없도록 브라우저 소스가 업데이트 되었는데 이유는 모바일에서
        에러가 발생하는 문제의 원인으로 지목되어 본 3가지 중요객체에 대해서는
        e.preventDefault() 또는 return false를 사용한 기능막기를 못하도록
        하였다.
    ...
    */
        ...
        $(document).on("mousewheel DOMMouseScroll",function(e){
           ...
           // 스크롤 안되게 하려고 html,body에 css로
           // overflow:hidden을 줘서 기본기능을 대신 먹는다.
           // -> 원래 원페이지 자동스크롤 사이트는 스크롤바 트랙대신
           // 별도의 표시자(인디케이터)를 구현해 준다.
            ...
            // 변수 = 경우1 || 경우2;
            // 변수에 경우1과 경우2 중 true(유효한것)이 먼저 할당된다.
            ...
            */
            ...
            //마우스 휠이 굴린 거리를 나타내는 정수 값을 반환합니다.
            //음수 값은 마우스 휠이 아래로 굴러 떨어졌음을 의미합니다. 
            //반환된 값은 항상 120의 배수입니다.

            //console.log("휠델타정보:"+delta);

            ////////////// 파이어폭스 일때 델타값 반대로 하기 //////////
            // 방법 : 
            // JS의 내장함수 test()를 사용하여 브라우저 정보를 읽어오는
            // navigator.userAgent를 이용
            // 브라우저 정보안에 "Firefox"라는 정보가 있으면 test()에서
            // true를 리턴함. 파이어폭스인지 알 수 있음
            ...
            /* 
                ...
                2. 모든 패턴 문자열은 찾을때 g라는 플래그 문자를 쓴다.
                3. 대소문자 구분없이 찾을 때는 i라는 플래그 문자를 쓴다.
                ex) /,/g
                -> 모든 콤마를 찾아라!
                /firefox/i
           ...
           if(/Firefox/i.test(navigator.userAgent)){
              ...
              delta = -delta; // 변수앞에 마이너스를 쓰면 부모 반대
           ...
           // .page의 top값으로 구하면 되지만 새로운버전의 제이쿼리에서 
           // 싱크 불일치가 발생함.
           ///////////////////////////////////////////////////////////
